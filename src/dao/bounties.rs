...
use crate::*;
use crate::dao::types::{ convert_old_to_new_token, OldAccountId };
use crate::dao::proposals::{ ProposalInput, ProposalKind };
...
impl Dao {
    ...
    pub fn bounty_claim(&mut self, id: u64, deadline: U64) {
        ...
        let mut claims = self.bounty_claimers
    ...
    pub fn bounty_giveup(&mut self, id: u64) -> PromiseOrValue<()> {
        ...
        let result = if
            env::block_timestamp() - claims[claim_idx].start_time.0 >
...
mod tests {
    ...
    use super::*;
    use crate::dao::types::{ Action, OLD_BASE_TOKEN };
