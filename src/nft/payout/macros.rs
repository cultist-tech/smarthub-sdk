...
macro_rules! impl_non_fungible_token_payout {
    ($contract:ident, $token:ident $(, $assert_transfer:ident)?) => {
        ...
        impl NonFungibleTokenPayout for $contract {
          #[payable]
          fn nft_transfer_payout(&mut self, receiver_id: AccountId, token_id: $crate::metadata::TokenId, approval_id: u64, balance: U128, max_len_payout: u32, memo: Option<String>) -> Payout {
